...
import { getUserDetails, TResponseUsersInfo } from "../../services/admin-api";
...
export default function EditProfileUser({
  ...
  function handleOnclick() {
    ...
    setUserDetailsData((prevData) => {
      if (!prevData) return prevData;
      return { ...prevData, isLocked: !prevData.isLocked };
    });
  }

  useEffect(() => {
    fetchUserDetails();
    setIsLocked(userDetailsData?.isLocked);
  }, []);
                  ...
                  <div className="flex items-center">
                    ...
                    <button
                      ...
                      className={`group flex w-14 h-8 p-1 ml-4 rounded-full transition-colors duration-300 ease-in-out overflow-hidden outline-none focus-visible:ring-2 focus-visible:ring-purple-400 ${
                        isLocked ? "bg-red-500" : "bg-slate-600"
                      }`}
                    >
                      <span
